...
set output '1p5v-diode.svg'
#set output '1p5v-diode.png'
...
set yrange [-5:15]
set xrange [0.95e-6:1.8e-6]

set xtics 0.00000085/10.0
set format x "%.2s"
#
unset key
unset ylabel
set ylabel "$U_{\\text{ВХ}}$ (В)"
plot "1p5v-diode-in" with lines
#
unset key
unset ylabel
set ylabel "$U_{\\text{ВИХ}}$ (В)"
plot "1p5v-diode-out" with lines
#
unset multiplot