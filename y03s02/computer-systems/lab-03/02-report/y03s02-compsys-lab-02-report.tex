	...
	\section{Хід роботи}
		...
		\begin{figure}[!htbp]
			...
			\begin{tikzpicture}[]
				...
				\node[main node, label={$t_1$}, below right = 2em and 0.45em of l05-d]  (l04-mul) {$\cdot$};
				\node[main node, label={$t_4$}, below right = 2em and 0.45em of l05-g]  (l04-plus2) {$+$};
				\node[main node, label={$t_2$}, below right = 2em and 0.45em of l05-k]  (l04-mul2) {$\cdot$};
				...
				\node[main node, label={$S$}, label position=below, below left  = 2em and 7em of l02-plus] (root-plus) {$+$};
