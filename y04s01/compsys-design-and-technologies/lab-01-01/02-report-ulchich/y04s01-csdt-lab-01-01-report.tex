...
\begin{titlepage}
	...
	\section{Висновок}
		Виконуючи дану лабораторну роботу, ми~ознайомились з~пакетом проектування~\textenglish{Auto\allcaps{CAD}} і~оволоділи основними прийомами зображення простих графічних об'єктів в~ньому. Результатом виконання роботи став документ з побудованими фігурами~(рис.~\ref{fig:doc-result}).

		\begin{figure}[!htbp]
			\centering
			\includegraphics[width=\columnwidth]{./assets/ulchich.pdf}
